...
void quiver(simulator::FieldGraph& graph, positionSet p, sf::Color color = simulator::colors::BLACK, double mag = 1);
...
void quiver(simulator::FieldGraph& graph, std::vector <positionSet>& p, sf::Color color = simulator::colors::BLACK, double mag = 1);
...
void quiver(simulator::FieldGraph& graph, Path& path, sf::Color color = simulator::colors::BLACK, double mag = 1);
